...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Plant Disease Dectection"))
        self.label.setToolTip(_translate("MainWindow", 
                                         "<html><head/><body><p><img src=\":/newPrefix/<baadme>\"/></p></body></html>"))
        self.label_2.setText(_translate("MainWindow", "Plant Disease Dectection"))
    ...
    def upload_image(self):
        ...
        path=str(path)
        print(path)
        model=load_model('plant_disease_detector_resnet50.h5') 
